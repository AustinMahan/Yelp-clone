...
exports.seed = function(knex, Promise) {
  ...
  .then(function () {
    return Promise.all([
      ...
      knex('restaurants').insert({name: 'qDoba', type: type_img[i].type, description: faker.lorem.paragraph(), location: `${faker.address.streetAddress()}, ${faker.address.city()}, ${faker.address.stateAbbr()}`, url: type_img[i].url}),
      changeI(),
      knex('restaurants').insert({name: faker.company.companyName(), type: type_img[i].type,
      description: faker.lorem.paragraph(), location: `${faker.address.streetAddress()}, ${faker.address.city()}, ${faker.address.stateAbbr()}`, url: type_img[i].url}),
      changeI(),
